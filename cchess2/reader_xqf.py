...
class XQFBuffDecoder(object) :
        ...
        def read_bytes(self, size):
                return bytearray(self.__read(size), encoding = "utf-8")
...
def __init_decrypt_key(buff_str):
        ...
        keys.F32Keys = bytearray("[(C) Copyright Mr. Dong Shiwei.]",encoding = "utf-8")
...
if __name__ == '__main__':
    ...
    #print len(moves)
    '''
    game = read_from_xqf("test\\EmptyTest.xqf")
    game.dump_info()
    '''
    ...
    game = read_from_xqf("test\\WildHouse.xqf")
    game.dump_info()
    #moves = game.dump_moves()
